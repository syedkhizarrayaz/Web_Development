    ...
    if (!$conn) {
        ...
        if ($result) {
            if ($result->num_rows > 0) {
                echo "<div class = container mt-3><h2>Details:</h2>";
                echo "<div class = container mt-3><table border=2px style= border-collapse:no-collapse; border=1px solid black><tr><th>Seat Number</th><th>First Name</th><th>Last Name</th><th>Gender</th><th>Email</th>
                    <th>Year</th><th>Address</th></tr> </div>";
                // output data of each row
                while ($row = $result->fetch_assoc()) {

                    echo "<div class = container mt-3><tr><td>" . $row["Seat_Number"] . "</td><td>" . $row["First_Name"] . "</td><td>" . $row["Last_Name"] . "</td><td>" . $row["Gender"] . "</td><td>" . $row["Email"] . "</td><td>" . $row["Year"] . "</td><td>" . $row["Address"] . "</td></tr> </div>";
                }
            } else {
                echo "0 results";
            }
